...
public class OgrenciController {
    ...
    @PostMapping("/kaydet")
    // @Valid: Modeldeki anotasyonları kontrol et. BindingResult: Hata sonuçlarını tutar.
    public String kaydet(@Valid @ModelAttribute Ogrenci ogrenci, BindingResult bindingResult, RedirectAttributes redirectAttributes) {

        // EĞER formda herhangi bir hata varsa (validation başarısız olduysa)
        if (bindingResult.hasErrors()) {
            // Kullanıcıyı formu tekrar doldurması için geri gönder.
            // Bu sefer formda hata mesajları görünür.
            return "ogrenci_formu";
        }
